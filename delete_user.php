...
<head>
    ...
    <title>CrimeSync: Delete User</title>
...
<body class="min-h-screen flex p-4">
    <!-- Sidebar with Admin Tips -->
    <div class="sidebar w-64 p-6 rounded-r-2xl shadow-lg space-y-4 text-pink-900">
        <h3 class="text-lg font-semibold">CrimeSync Admin Tips</h3>
        <ul class="text-sm space-y-2">
            <li>🛡️ Monitor all reports regularly.</li>
            <li>🔒 Ensure user data security.</li>
            <li>📞 Coordinate with officers promptly.</li>
            <li>🕵️‍♂️ Verify user registrations.</li>
        </ul>
    </div>
    ...
    <div class="flex-1 flex items-center justify-center">
        <div class="container w-full max-w-md rounded-2xl shadow-2xl p-8 space-y-6">
            ...
            <?php else: ?>
                <p class="text-center text-pink-700">No action performed yet.</p>
            <?php endif; ?>

            <!-- Back Link -->
            <div class="text-center">
                <a href="admin_dashboard.php" class="inline-block bg-pink-500 text-white text-center py-3 px-6 rounded-lg font-semibold hover:bg-pink-600 transition duration-300 btn">
            ...
            <div class="text-center text-sm text-pink-700">
                Managing users for a safer community 🌸
            </div>
        </div>
    </div>
</body>
